<div class="box" id="nigeria-vat-form">
<div class="container mt-5">
    <div class="card">
        <div class="card-header text-danger">
            <h4 class="card-title">Nigeria VAT Calculation and Invoice Data Input</h4>
        </div>
        <div class="card-body">
                    ...
                    <div id="itemsContainer">
                        <div class="item-entry mb-3">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <label for="unitPrice0" class="form-label">Unit Price (₦): <span class="text-danger">*</span></label>
...
<?php
    include_once site . "/region/nigeria/VAT/form.handler.php";
    ?>