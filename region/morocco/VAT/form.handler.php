...
<script>
    $(document).ready(function() {
            ...
            const newItem = `
                <div class="item-entry mb-3">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <label for="unitPrice${itemCount}" class="form-label">Unit Price (MAD): <span class="text-danger">*</span></label>
        ...
        $('#calculate-vat').click(function () {
            ...
            $.ajax({
                url: 'https://complytech.mdskenya.co.ke/endpoint/engine/region/morocco/vat.php',
                method: 'POST',
