<div class="col-xl-6 col-12">
    <div class="box">
        <div class="box-header no-border pb-0">
            <h4 class="box-title" id="greeting">Good Morning Guest</h4>
        </div>
        <div class="box-body">
            <div class="row">
                <div class="col-md-6 col-12">
                    <div class="info-box bg-transparent no-shadow px-0 min-h-80">
                        ...
                        <div class="info-box-content pb-0">
                          <p class="mb-0 fs-16">Requests Made</p>
                          <h2 class="my-0 fw-500 text-danger" id="requests-made">0</h2>
                        </div>
                     </div>
                </div>
                <div class="col-md-6 col-12">
                ...
                <div class="col-md-6 col-12">
                    <div class="info-box bg-transparent no-shadow px-0 min-h-80">
                        ...
                        <div class="info-box-content pb-0">
                          <p class="mb-0 fs-16">Payrolls</p>
                          <h2 class="my-0 fw-500 text-info" id="payrolls">0</h2>
                        </div>
                     </div>
                </div>
                <div class="col-md-6 col-12">
                    <div class="info-box bg-transparent no-shadow px-0 min-h-80">
                        ...
                        <div class="info-box-content pb-0">
                          <p class="mb-0 fs-16">Invoices</p>
                          <h2 class="my-0 fw-500 text-info" id="invoices">0</h2>
                        </div>
                     </div>
                </div>
            </div>
	...
	<?php
    include_once site . "/dashboard/pages/overview/content/overview_info/overview.info.js.php";
    ?>