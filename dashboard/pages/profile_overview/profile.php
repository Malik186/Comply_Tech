...
defined("page_title") or define("page_title", "Profile");
...
<body id="crancy-dark-light">
    ...
    <!-- Header-->
    <?php
    include_once site . "/dashboard/modules/header/profile.header.php";
    ?>

    <!-- Content-->
    <?php
    include_once site . "/dashboard/pages/profile_overview/content/content.php";
    ?>
    </div>
