...
defined("page_title") or define("page_title", "Notification");
...
<body id="crancy-dark-light">
    ...
    <!-- Header-->
    <?php
    include_once site . "/dashboard/modules/header/notification.header.php";
    ?>

    <!-- Content-->
    <?php
    include_once site . "/dashboard/pages/notification/content/content.php";
    ?>
    </div>
...
<script src="/dashboard/js/jquery.min.js"></script>
    ...
    <?php
    include_once site . "/dashboard/pages/analytics/script.php";
    ?>
</body>
