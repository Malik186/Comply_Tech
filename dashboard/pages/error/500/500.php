...
<body class="hold-transition theme-primary bg-img" style="background-image: url(/dashboard/img/auth-bg/bg-5.jpg)">
    <!-- Content-->
    <?php
    include_once site . "/dashboard/pages/error/500/content/content.php";
    ?>
