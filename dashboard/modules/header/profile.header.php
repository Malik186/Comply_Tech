            ...
            <div class="col-12">
              ...
              <div class="crancy-header__inner">
                <div class="crancy-header__middle">
                  ...
                  >
                    <img src="/dashboard/img/arrow-icon.svg" />
                  </div>
                  <div class="crancy-header__heading">
                  <h3 class="crancy-header__title m-0" style="color: #f6d420;">Social Transact- Profile</h3>
                    <p class="crancy-header__text" style="color: white;">
                      Engage with your profile and draft up some fundraisers!
                    </p>
                  </div>
                        ...
                        <div class="crancy-header__right">
                          ...
                          <div class="crancy-header__single">
                            ...
                            <a class="crancy-language_main">
                              <img src="/dashboard/img/flag-1.png" />
                            </a>
                            <!-- Dropdown List -->
                            <div class="crancy-dropdown crancy-language">
                              <div class="crancy-dropdown__heading">
                                ...
                                <a href="#" class="crancy-dropdown__toggle"
                                  ><img src="/dashboard/img/toggle-icons.svg"
                                /></a>
                              </div>
                                ...
                                <ul class="crancy-dlanguage">
                                  <a class="active" href="#">
                                    <span class="crancy-dlanguage__icon"
                                      ><img src="/dashboard/img/language-check-icon.svg"
                                    /></span>
                                    <img
                                      class="crancy-dlanguage__img"
                                      src="/dashboard/img/flag-1.png"
                                    />
                          ...
                          <div class="crancy-header__options">
                            <!-- Header Message -->
                            <div
                              class="crancy-header__settings"
                            >
                              <a class="crancy-header__blink" href="#">
                              <img src="/dashboard/img/mess.png" alt="#"/>
                              </a>
                              <!-- Dropdown List -->
                              <div
                              ...
                              >
                                <div class="crancy-dropdown__heading">
                                  <div class="crancy-dropdown__close">
                                  <img src="/dashboard/img/chat.png" alt="#"/>
                                  </div>
                                  <h3 class="crancy-dropdown__title">
                                    Messages
                                  </h3>
                                ...
                                >
                                  ...
                                  <li>
                                    <div class="crancy-header-messages__inner">
                                      ...
                                      >
                                        <img
                                          src="/dashboard/img/chat-author1.png"
                                          alt="#"
                                        />
                                        <div
                                  ...
                                  <li>
                                    <div class="crancy-header-messages__inner">
                                      <div
                                        class="crancy-header-messages__author"
                                      >
                                        <img src="/dashboard/img/notify-1.png" alt="#" />
                                        <div
                                          class="crancy-header-messages__contnt"
                                        >
                                          <div
                                  ...
                                  <li>
                                    <div class="crancy-header-messages__inner">
                                      <div
                                        class="crancy-header-messages__author"
                                      >
                                        <img src="/dashboard/img/notify-2.png" alt="#" />
                                        <div
                                          class="crancy-header-messages__contnt"
                                        >
                                          <div
                                  ...
                                  <li>
                                    <div class="crancy-header-messages__inner">
                                      <div
                                        class="crancy-header-messages__author"
                                      >
                                        <img src="/dashboard/img/notify-3.png" alt="#" />
                                        <div
                                          class="crancy-header-messages__contnt"
                                        >
                                          <div
                          ...
                          <div class="crancy-header__single">
                            <a href="profile-overview.php"
                              ><div class="crancy-header__author-img">
                                <img src="/dashboard/img/profile-icon.svg" alt="#" /></div
                            ></a>
