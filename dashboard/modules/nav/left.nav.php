        ...
        <div class="admin-menu">
          ...
          <div class="logo crancy-sidebar-padding pd-right-0">
            <a class="crancy-logo" href="/">
              <!-- Logo for Default -->
              <img class="crancy-logo__main" src="/dashboard/img/ST-logo.png" alt="#" />
              <img
              ...
              <img
                ...
                src="/dashboard/img/ST-icon(40 x 40 px).png"
                alt="#"
              />
              <img
          ...
          <div class="admin-menu__one crancy-sidebar-padding mg-top-20">
            ...
            <div class="menu-bar">
              <ul id="CrancyMenu" class="menu-bar__one crancy-dashboard-menu">
                <li class="active">
                  <a class="collapsed"
                    ...
                    ><span class="menu-bar__text">
                      ...
                      <span class="menu-bar__name">Overview</span></span
                    >
                    </a>
                </li>
                <li>
                  <a class="collapsed" href="/transaction.php"
                    ><span class="menu-bar__text">
                      <span class="crancy-menu-icon crancy-svg-icon__v1">
                        <svg
                          class="crancy-svg-icon"
                ...
                <li>
                  <a class="collapsed" href="/my-wallet.php"
                    ><span class="menu-bar__text">
                      <span class="crancy-menu-icon crancy-svg-icon__v1">
                        <svg
                          class="crancy-svg-icon"
                ...
                <li>
                  <a class="collapsed" href="/analytics.php"
                    ><span class="menu-bar__text">
                      <span class="crancy-menu-icon crancy-svg-icon__v1">
                        <svg
                          class="crancy-svg-icon"
                ...
                <li>
                  <a class="collapsed" href="/statistics.php"
                    ><span class="menu-bar__text">
                      <span class="crancy-menu-icon crancy-svg-icon__v1">
                        <svg
                          class="crancy-svg-icon"
                ...
                <li>
                  <a class="collapsed" href="/notifications.php"
                    ><span class="menu-bar__text">
                      <span class="crancy-menu-icon crancy-svg-icon__v1">
                        <svg
                          class="crancy-svg-icon"
          ...
          <div class="crancy-sidebar-padding pd-btm-40">
            ...
            <div class="menu-bar">
              <ul class="menu-bar__one crancy-dashboard-menu" id="CrancyMenu">
                <li>
                  <a href="/support-ticket.php" class="collapsed"
                    ><span class="menu-bar__text">
                      <span class="crancy-menu-icon crancy-svg-icon__v1">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                ...
                <li>
                  <a href="/profile-info.php" class="collapsed"
                    ><span class="menu-bar__text">
                      <span class="crancy-menu-icon crancy-svg-icon__v1">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
            ...
            <div
              ...
              style="background-image: url('/dashboard/img/support-bg.png')"
            >
              <div class="crancy-support-card__sing">
                <img src="/dashboard/img/support-sign-icon.svg" />
              </div>
              <h4 class="crancy-support-card__title">Help Center</h4>
              <p class="crancy-support-card__text">
                Having some issues? contact us now if you do!
              </p>
              <a
