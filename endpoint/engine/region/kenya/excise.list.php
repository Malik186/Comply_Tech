    ...
    if ($results) {
        ...
        foreach ($results as $result) {
            $data[] = [
                ...
                'typeOfGoods' => (float)$result['typeOfGoods'],
                'goodsDescription' => (float)$result['goodsDescription'],
                ...
                'goodsOrigin' => (float)$result['goodsOrigin'],
                'alcoholType' => (float)$result['alcoholType'],
                'alcoholQuantity' => (float)$result['alcoholQuantity'],
                'tobaccoType' => (float)$result['tobaccoType'],
                'tobaccoQuantity' => (float)$result['tobaccoQuantity'],
                'petroleumType' => (float)$result['petroleumType'],
                'petroleumQuantity' => (float)$result['petroleumQuantity'],
                'vehicleType' => (float)$result['vehicleType'],
