...
class SouthAfricanCITCalculator {
    ...
    public function calculateTax($data, $username) {
        try {
            ...
            // Insert into tax_overview if saveResults was successful
            $this->insertTaxOverview($username);
    ...
    private function insertTaxOverview($username) {
        try {
            $stmt = $this->pdo->prepare("
                INSERT INTO tax_overview (Username, Tax_Type, Status, Activity, Report, Payroll, Invoice) 
                VALUES (:username, 'South_Africa CIT', 1, 1, 1, 0, 0)
            ");
            ...
            echo "Error inserting into tax_overview: " . $e->getMessage();
        }
    }
